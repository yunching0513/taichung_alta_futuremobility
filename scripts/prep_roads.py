...
#
# 顏色照臺灣公路編號標誌的既有色系：**國道與省道的編號牌都是藍底白字
# （國道是盾形、省道是梅花形），快速公路的梅花形是紅底白字。**
# 因此紅色留給快速公路，國道與省道共用藍色，用深淺分：
# 國道深、省道淺。這不是配色偷懶，而是深淺本身就編碼了等級，
# 與線寬指向同一件事，讀者不必回頭對圖例。
CLASSES = [
    ('省道', '省道', '#4A90D9', 1.1),
    ('快速公路', '快速公路', '#D0121B', 1.9),
    ('國道', '國道', '#0A2E6E', 2.8),
]
...
def main():
    ...
    blob = {
        ...
        'caveat': ('分級照來源檔的 class 欄位：國道、快速公路、省道。'
                   ...
                   '顏色照臺灣公路編號標誌：國道與省道的編號牌都是藍底、快速公路是紅底，'
                   '因此紅色留給快速公路，國道與省道用同一個藍的深淺分。'
